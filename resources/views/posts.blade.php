				...
				@foreach ($posts->skip(1) as $post)	
					<div class="col-md-4 mb-4">
						<div class="card h-100">
							...
							<a href="/posts/{{ $post->slug }}" class="text-decoration-none text-dark"><img src="https://source.unsplash.com/500x400?{{ $post->category->name }}"  class="card-img-top" alt="{{ $post->category->name }}"></a>
							...
							<div class="card-body">
								...
								<a href="/posts/{{ $post->slug }}" class="">Read more</a>
							</div>
						</div>
					</div>
				@endforeach
